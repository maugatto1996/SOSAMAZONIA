...
public class PlayerController : MonoBehaviour
{
    ...
    public void AtualizaHUD()
    {
        ...
        {
            hudVelocidadeVertical.text = string.Format("VELOC V.: {0} {1}", velocidadeVertical, setaCima);
        }
        ...
        {
            hudVelocidadeHorizontal.text = string.Format("VELOC H.: {0} {1}", velocidadeHorizontal, setaEsquerda);
        }
